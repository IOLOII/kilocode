export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Activé",
  "settings.agentBehaviour.mcp.disabled": "Désactivé",
  "settings.agentBehaviour.mcp.toggle": "Activer/désactiver le serveur MCP",
