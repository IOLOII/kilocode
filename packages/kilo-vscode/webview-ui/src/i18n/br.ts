export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Ativado",
  "settings.agentBehaviour.mcp.disabled": "Desativado",
  "settings.agentBehaviour.mcp.toggle": "Ativar/desativar servidor MCP",
