export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Ingeschakeld",
  "settings.agentBehaviour.mcp.disabled": "Uitgeschakeld",
  "settings.agentBehaviour.mcp.toggle": "MCP-server in-/uitschakelen",
