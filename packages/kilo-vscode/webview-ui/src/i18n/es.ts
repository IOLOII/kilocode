export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Activado",
  "settings.agentBehaviour.mcp.disabled": "Desactivado",
  "settings.agentBehaviour.mcp.toggle": "Activar/desactivar servidor MCP",
