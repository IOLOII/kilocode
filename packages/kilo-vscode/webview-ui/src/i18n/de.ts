...
export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Aktiviert",
  "settings.agentBehaviour.mcp.disabled": "Deaktiviert",
  "settings.agentBehaviour.mcp.toggle": "MCP-Server aktivieren/deaktivieren",
