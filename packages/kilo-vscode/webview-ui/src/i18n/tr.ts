export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Etkin",
  "settings.agentBehaviour.mcp.disabled": "Devre dışı",
  "settings.agentBehaviour.mcp.toggle": "MCP sunucusunu etkinleştir/devre dışı bırak",
