export const dict = {
  ...
  "settings.agentBehaviour.mcp.enabled": "Включено",
  "settings.agentBehaviour.mcp.disabled": "Отключено",
  "settings.agentBehaviour.mcp.toggle": "Включить/отключить сервер MCP",
